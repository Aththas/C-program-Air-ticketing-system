...
#include<windows.h>//use for system time and system cmds
...
//                      NEW FUNCTION - showing continents
 void flight_routes_continents() // lahiru
{
      int continent;
      printf("\n\n\t FLIGHT ROUTES\n\n");
      printf("\t 1 - ASIA\n");
...
//                      NEW FUNCTION
void daily_flight_times()// jeevaka
{
      int time;
